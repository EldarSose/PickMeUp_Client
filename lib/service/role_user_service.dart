...
import 'package:pickmeup/models/role_user.dart';

class RoleUserService {
  Future<List<RoleUser>> getAllRoleUser() async {
  ...
  Future<RoleUser> getRoleUserById(int id) async {
  ...
  Future<RoleUser> addRoleUser(RoleUser roleUser) async {
  ...
  Future<RoleUser> editRoleUser(RoleUser roleUser) async {
