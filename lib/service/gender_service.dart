...
import 'package:pickmeup/models/gender.dart';
...
class GenderService {
  ...
  Future<Gender> getGenderById(int id) async {
  ...
  Future<Gender> addGender(Gender gender) async {
  ...
  Future<Gender> editGender(Gender gender) async {
