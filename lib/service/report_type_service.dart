...
import 'package:pickmeup/models/report_type.dart';

class ReportTypeService {
  Future<List<ReportType>> getAllReportType() async {
  ...
  Future<ReportType> getReportTypeById(int id) async {
  ...
  Future<ReportType> addReportType(ReportType reportType) async {
  ...
  Future<ReportType> editReportType(ReportType reportType) async {
