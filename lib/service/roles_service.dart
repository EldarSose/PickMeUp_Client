...
import 'package:pickmeup/models/roles.dart';
...
class RolesService {
  ...
  Future<Roles> getRolesById(int id) async {
  ...
  Future<Roles> addRoles(Roles role) async {
  ...
  Future<Roles> editRoles(Roles role) async {
