...
class WindowsRegisterForm extends StatefulWidget {
  const WindowsRegisterForm({Key? key}) : super(key: key);

  @override
  State<WindowsRegisterForm> createState() => _RegisterFormState();
}

class _RegisterFormState extends State<WindowsRegisterForm> {
